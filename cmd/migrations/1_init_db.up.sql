...
INSERT INTO `t_monitor_item` VALUES ('19', '1', '(基础)CPU的平均使用率', 'ecs_cpu_base_usage', 'instance', '100 * avg(irate(ecs_base_vcpu_seconds{$INSTANCE}[6m]))', NULL, NULL, '%', NULL, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, 'chart,rule,scaling');
